# CNN-LSTM-Attention Training Script for RTX 3070Ti
# Model 2: CNN-LSTM with Temporal Attention
...
RESULTS_PATH = "D:/Coding/Group/HAR-Deep-Learning-Comparison/results/model2-cnn-lstm-attention/"
...
def train_model():
    print("\n" + "="*60)
    print("MODEL 2: CNN-LSTM-ATTENTION")
    print("="*60)
    ...
    plt.title(f'Model 2: CNN-LSTM-Attention Confusion Matrix\nAccuracy: {best_accuracy:.2f}%')
    ...
    ax2.set_title('Model 2: CNN-LSTM-Attention Training & Test Accuracy')
    ax2.legend()
