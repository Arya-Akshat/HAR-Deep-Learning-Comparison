...
from model import LSTMModel, Bidir_LSTMModel, Res_LSTMModel, Res_Bidir_LSTMModel, Bidir_LSTM_Attention_Model, init_weights
...
def main():
    ...
    for lr in learning_rate:
        ...
        params = train(net, X_train, y_train, X_test, y_test, opt=opt, criterion=criterion, epochs=epochs, clip_val=clip_val, device=device)
        evaluate(params['best_model'].to(device), X_test, y_test, criterion, device=device)
